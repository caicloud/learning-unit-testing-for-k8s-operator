...
// TestAnonymousDeployment handles the situation that `Foo.Spec.DeploymentName` is empty.
// Given a Foo instance which `Spec.Deployment` == "",
// When the fixture(controller) is run,
// Then no action will be captured.
func TestAnonymousDeployment(t *testing.T) {
	// --------------------------------------------------------
	// Lab 1: Please add the logic here.
	// --------------------------------------------------------
}
